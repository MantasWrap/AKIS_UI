  ...
  return (
    <section className="ts-panel">
      ...
      {!error && !currentItem && !loading && datasetId && (
        <p className="ts-helper">
          No manual items available yet. For Phase B we use seeded in-memory
          items per dataset. Later this will be real frames from media.
        </p>
      )}
      {!error && !currentItem && !loading && !datasetId && (
        <p className="ts-helper">
        ...
        <div className="ts-manual-layout">
          <div className="ts-manual-media">
            <div className="ts-media-placeholder">
              ...
              <p className="ts-helper">
                Media preview will be wired later to real frames or video. For
...
export function TrainingStudioItemsPage() {
  ...
  return (
    <section className="ts-page">
      ...
      {activeTab === 'live' && (
        <p className="ts-helper">
          Live Items review will be implemented in Phase E. It will show items
          captured from Jetson during real conveyor operation with the same
          one-item Save and Next flow.
        </p>
      )}
